...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7465487364").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/VyomXMusic"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/VyomXSupport"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/VyomXMusic")
